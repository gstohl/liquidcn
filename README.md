...
- **Copy/paste or CLI** — use `npx liquidcn add button` or copy files directly
...
```bash
npx liquidcn add button card dialog
```

Or add everything:

```bash
npx liquidcn add --all
```
