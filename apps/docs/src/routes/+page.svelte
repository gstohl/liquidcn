...
<div class="min-h-screen text-white" style="background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 25%, #a855f7 50%, #d946ef 75%, #6366f1 100%); --color-foreground: oklch(0.97 0 0); --color-muted-foreground: oklch(0.85 0 0); --color-destructive: oklch(0.7 0.2 25);">
	...
	<header class="relative overflow-hidden">
		...
		<div class="relative max-w-5xl mx-auto px-6 pt-20 pb-16 text-center">
			...
			<div class="mt-6">
				<code class="glass-light rounded-lg px-4 py-2 text-sm font-mono">npx liquidcn add button</code>
			</div>
		</div>
	</header>
		...
		<section>
			...
			<Accordion type="single">
				...
				<AccordionItem value="item-2">
					...
					<AccordionContent>
						Use the CLI to add components to your project: <code class="glass-light rounded px-1.5 py-0.5 text-xs font-mono">npx liquidcn add button</code>
					</AccordionContent>
				</AccordionItem>
